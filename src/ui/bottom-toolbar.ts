...
class BottomToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const navToggle = new Button({
            id: 'bottom-toolbar-nav-toggle',
            class: 'bottom-toolbar-toggle',
            icon: 'E228' // "Map text" icon code from playcanvas fonts
        });
        ...
        navToggle.dom.addEventListener('click', () => events.fire('navigation.toggle'));
        ...
        events.on('navigation.visible', (visible: boolean) => {
            navToggle.dom.classList[visible ? 'add' : 'remove']('active');
        });
        ...
        tooltips.register(navToggle, 'Toggle Navi-Splat Tools');
