...
class EditorUI {
    ...
    constructor(events: Events) {
        ...
        // Check for Viewer Mode URL Parameter
        ...
        events.function('show.videoSettingsDialog', async () => {
            ...
            if (videoSettings) {
                ...
                try {
                    ...
                    const suggested = `${removeExtension(docName ?? 'navi_splat')}${fileExtension}`;
