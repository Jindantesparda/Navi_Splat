...
class Menu extends Container {
    constructor(events: Events, args = {}) {
        ...
        const helpMenuPanel = new MenuPanel([{
            ...
            icon: 'E232',
            onSelect: () => window.open('https://developer.playcanvas.com/user-manual/gaussian-splatting/editing/navi-splat/', '_blank')?.focus()
        }, {
            ...
            icon: 'E259',
            onSelect: () => window.open('https://github.com/playcanvas/navi-splat', '_blank')?.focus()
        }, {
            text: localize('menu.help.log-issue'),
            icon: 'E336',
            onSelect: () => window.open('https://github.com/playcanvas/navi-splat/issues', '_blank')?.focus()
        }, {
            // separator
        }, {
