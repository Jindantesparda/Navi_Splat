...
const registerEditorEvents = (events: Events, editHistory: EditHistory, scene: Scene) => {
    ...
    [
        ...
        'selection.changed', 'tool.coordSpace', 'navigation.changed'
    ].forEach((eventName) => {
        events.on(eventName, () => {
    ...
    events.function('docSerialize.view', () => {
        ...
        return {
            ...
            navigation: events.invoke('navigation.serialize')
        };
    });
    ...
    events.function('docDeserialize.view', (docView: any) => {
        ...
        events.fire('navigation.deserialize', docView.navigation ?? null);
    });
};
